...
export default function GroupInfo() {
  ...
  // const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY3YThiZmVhNGNlNjdkYzM4MGY1YzY1ZSIsInJvbGUiOiJTVVBFUl9BRE1JTiIsImlhdCI6MTczOTk3MjI3MSwiZXhwIjoxNzM5OTc1ODcxfQ.9RS7ocntmFvX8RQbTtI2b-m3qj8Z4Pwqg1VrJXYhBmg"
  ...
  const addAdmin = async () => {
    ...
    try {
      ...
      console.log("✅ Response add admin:", response.data);
